	...
	<div class="row">
		...
		<div class="col-md-6">
			<form class="form-inline my-2 my-lg-0" action="search.jsp" method="post">
      			<input class="form-control mr-sm-2" type="search" name="check"
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active"><a class="nav-link" 
      	  href="all_recent_services.jsp">Recent Services</a></li>
      <li class="nav-item active"><a class="nav-link" href="all_new_services.jsp">New Services</a></li>
      <li class="nav-item active"><a class="nav-link" href="all_old_services.jsp">Old Services</a></li>
    </ul>
    <form class="form-inline my-2 my-lg-0">
      <a href="setting.jsp" class="btn btn-light my-2 my-sm-0" type="submit">
      	  <i class="fa-solid fa-bars"></i> Setting</a>
      <button class="btn btn-light my-2 my-sm-0 ml-1" type="submit">
      	  <i class="fa-sharp fa-solid fa-headset"></i> Contact Us</button>
    </form>
  </div>
</nav>