					...
					<h3 class="text-center text-success">Your Selected Item</h3>
						<table class="table table-striped">
				  			...
				  			<tbody>
                				...
                				List<Cart> cart = dao.getServiceByUser(user.getId());
                				...
                				<tr>
				      				...
				      				<td><%=c.getPrice() %></td>
				      				<td>
				      				<a href="remove_service?cartid=<%=c.getCartid()%>&&serviceid=<%=c.getServiceid()%>&&userid=<%=c.getUserId()%>" 
						...
						<input type="hidden" value="${userobj.id}" name="id">
							<div class="form-row">
  							...
  							<div class="form-group">
  								<lable>Payment Mode</lable> <select class="form-control" name="payment">
  							...
  							<a href="index.jsp" class="btn btn-success">See Other Services</a>
  							</div>
